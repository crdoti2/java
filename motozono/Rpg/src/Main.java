...
public class Main {
	public static void main(String[] args) throws SQLException{
		...
		while(true){
				...
				System.out.println("1:を入力すると戦うモンスターを選べる。 2:を入力するとアイテムを買う。 3:を入力すると回復できる。4:を入力するとセーブ。 5:を入力するとロードするよ。");
				...
				h.CheckData();
				System.out.print("何番目に保存しますか？ > ");
				int save = new java.util.Scanner(System.in).nextInt();
				h.SaveData(save);
			}else if(input == 5){
				h.CheckData();
				System.out.print("何番目をロードしますか？ > ");
				int load = new java.util.Scanner(System.in).nextInt();
				h.LoadData(load);
